...
2. Section **"Phản hồi review"** có nội dung không? **Rỗng thì KHÔNG hỏi lại** —
   ...
   > `/tlm-qa-write-cases $1`; còn muốn sửa thì ghi vào section đó rồi chạy lại lệnh này.
...
- **Câu hỏi mục F được trả lời** → không còn là giả định; ghi lại câu trả lời thật,
  ...
  "Cao" (xem `skill: tlm-qa-checklist-format`).
...
4. Đã sạch → mời chạy `/tlm-qa-write-cases $1`
...
- KHÔNG viết test case, KHÔNG tạo file Excel — đó là `/tlm-qa-write-cases`.
