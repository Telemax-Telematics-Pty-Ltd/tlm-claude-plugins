...
// Thư mục project e2e KHÔNG cố định: `/tlm-qa-setup` (skill tlm-qa-e2e-scaffold) để người dùng
...
// Tiền tố biến env cũng do tlm-qa-e2e-scaffold đặt theo tên app (VD ACME_USER).
