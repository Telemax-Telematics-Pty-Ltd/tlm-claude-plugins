...
code (xem mục "Giọng văn" ở skill `tlm-qa-testcase-template`).
...
## Quan hệ với sheet "Common Validate" và skill `tlm-qa-testcase-template`
...
- Test case cụ thể được đổ vào sheet "Test Cases" qua skill `tlm-qa-testcase-template`.
