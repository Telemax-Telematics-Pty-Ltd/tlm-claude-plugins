...
Khi team bổ sung collection: đổi Trạng thái thành `CÓ`, chạy lại `/tlm-qa-run`; các case
...
## Bước 2 — Phủ case theo nhóm API của tlm-qa-common-validate

Dùng `tlm-qa-common-validate/reference/api.md` làm checklist phủ ca biên, cụ thể hoá theo
...
- Việc tạo bug do `tlm-qa-clickup-bug-format` + `/tlm-qa-file-bugs` lo, không thuộc skill này.
