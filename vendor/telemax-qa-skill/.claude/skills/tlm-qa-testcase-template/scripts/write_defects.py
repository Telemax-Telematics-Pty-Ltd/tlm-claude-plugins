...
def mode_status(wb):
    """Đọc-only: trả mọi con số mà cổng đầu vào của /tlm-qa-run cần, trong MỘT lệnh.
    ...
    # Đề xuất round — đúng ba trạng thái như cổng 3 của /tlm-qa-run mô tả.
    if done2:
    ...
    return {
        ...
        "note": ("Đọc-only, không ghi gì, không tạo .bak. Trả lời cổng 2/3/4 của /tlm-qa-run "
